...
open = "https://img.shields.io/badge/${group_name}-open-green"
 -->
Join the public TestFlight (click on one of the badges): <!-- testflight-status --> [![AstroDX Group A (JiNALE) TestFlight status](https://img.shields.io/badge/Group%20A%20%28JiNALE%29-closed-yellow)](https://testflight.apple.com/join/rACTLjPL) [![AstroDX Group B (JiNALE) TestFlight status](https://img.shields.io/badge/Group%20B%20%28JiNALE%29-closed-yellow)](https://testflight.apple.com/join/ocj3yptn) [![AstroDX Group C (JiNALE) TestFlight status](https://img.shields.io/badge/Group%20C%20%28JiNALE%29-closed-yellow)](https://testflight.apple.com/join/CuMxZE2M) [![AstroDX Group D (JiNALE) TestFlight status](https://img.shields.io/badge/Group%20D%20%28JiNALE%29-closed-yellow)](https://testflight.apple.com/join/T6qKfV6f) [![AstroDX Group E (JiNALE) TestFlight status](https://img.shields.io/badge/Group%20E%20%28JiNALE%29-closed-yellow)](https://testflight.apple.com/join/sMm1MCYc) <!-- /testflight-status -->
