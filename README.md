...
open = "https://img.shields.io/badge/${group_name}-open-green"
 -->
<<<<<<< HEAD
Join the public TestFlight (click on the badges): [![AstroDX Group A TestFlight status](https://img.shields.io/badge/Group%20A-full-red)](https://testflight.apple.com/join/rACTLjPL) [![AstroDX Group B TestFlight status](https://img.shields.io/badge/Group%20B-full-red)](https://testflight.apple.com/join/ocj3yptn).
=======
Join the public TestFlight (click on one of the badges): [![AstroDX Group A TestFlight status](https://img.shields.io/badge/Group%20A-open-green)](https://testflight.apple.com/join/rACTLjPL) [![AstroDX Group B TestFlight status](https://img.shields.io/badge/Group%20B-open-green)](https://testflight.apple.com/join/ocj3yptn).
>>>>>>> 3b01e10 (Add TestFlight status to commit message)
